					...
					<article class="col1">
						...
						<div class="wrapper">
							...
							<p>USA<br>
									...
									San Diego<br>
									+354 5635600<br>
									<a href="mailto:">elenwhite@mail.com</a></p>
						</div>		
						<h3 class="pad_top1">Miscellaneous</h3>
						<p class="miscellaneous">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusan- tium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta.</p>
					</article>
				</div>
			</section>
<!-- / content  -->
