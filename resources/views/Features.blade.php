				...
				<div class="wrapper">
					...
					<nav>
						<ul id="menu">
							...
							<li id="menu_active"><a href="Features">Features</a></li>
	...
	<section id="content">
		<div class="wrapper">
			<article class="col1">
				...
				<p class="pad_bot1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris tempor, justo sodales fermentum consectetur, libero tellus fermentum feugiat molestie orci enim sit amet libero. Vivamus non velit in nibh tincidunt tristique tincidunt leo. Phasellus eget nulla odio. Maecenas gravida lorem integer imperdiet euismod neque quis luctus.</p>
				<div class="wrapper">
