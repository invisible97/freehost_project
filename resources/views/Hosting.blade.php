				...
				<div class="wrapper">
					...
					<nav>
						<ul id="menu">
							...
							<li id="menu_active"><a href="Hosting">Hosting</a></li>
					...
					<article class="col1">
						<article class="col2">
							...
							<ul class="list2">
								...
								<li><img src="images/icon_6.png" alt="">Money Back Guarantee</li>
								...
								<li><img src="images/icon_10.png" alt="">MySQL Databases</li>
							</ul>
						</article>
						<article class="col3">
